...
<body class="img" style="background-image: url(./imagenes/bg.png);">
  ...
  <?php $categoria = 'libro'; include './vistas/cards/cardVertical.php'?>
  </div>

  <div class="contenedor1">
  <h5 style="color: white;">Películas:</h5>
  <?php $categoria = 'pelicula'; include './vistas/cards/cardVertical.php' ?>
  </div>

  <div class="contenedor1">
  <h5 style="color: white;">Cómics:</h5>
  <?php $categoria = 'comic'; include './vistas/cards/cardVertical.php'?>
  </div>
